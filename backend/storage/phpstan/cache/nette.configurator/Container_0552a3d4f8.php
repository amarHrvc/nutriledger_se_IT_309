...
class Container_0552a3d4f8 extends _PHPStan_584420d24\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0436(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0552a3d4f8 $container)
			{
	...
	public function createServiceContainer(): Container_0552a3d4f8
	{
		return $this;
	}
