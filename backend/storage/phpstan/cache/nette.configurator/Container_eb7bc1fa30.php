...
class Container_eb7bc1fa30 extends _PHPStan_584420d24\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0436(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_eb7bc1fa30 $container)
			{
	...
	public function createServiceContainer(): Container_eb7bc1fa30
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PSModulePath' => 'C:\Users\Korisnik\Documents_default\WindowsPowerShell\Modules;C:\Program Files\WindowsPowerShell\Modules;C:\WINDOWS\system32\WindowsPowerShell\v1.0\Modules',
				...
				'WT_SESSION' => '1447fc1a-26ae-4cee-8c4d-40846922b5e0',
			],
		];
	}
